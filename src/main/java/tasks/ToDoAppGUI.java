...
public class ToDoAppGUI {
    ...
    private final JButton addButton = new JButton("Dodaj zadanie");
    private final JButton searchDateButton = new JButton("Szukaj");
    private final JButton searchDateIntervalButton = new JButton("Szukaj");
    private final JButton searchTitleButton = new JButton("Szukaj");
    private final JButton searchPriorityButton = new JButton("Szukaj");

    private final JButton deleteByDateButton = new JButton("Skasuj");

    private final JButton deleteByDateIntervalButton = new JButton("Skasuj");
    ...
    private JPanel createInputPanel() {
        ...
        inputPanel.add(new JLabel("Priorytet:"));
    ...
    private JPanel createSearchDatePanel() {
        ...
        searchDatePanel.add(new JLabel("Szukaj po dacie:"));
    ...
    private JPanel createSearchDateIntervalPanel() {
        ...
        searchDateIntervalPanel.add(new JLabel("Szukaj wg przedziału dat:"));
    ...
    private JPanel createSearchTitlePanel() {
        ...
        searchTitlePanel.add(new JLabel("Szukaj po tytule:"));
    ...
    private JPanel createSearchPriorityPanel() {
        ...
        searchPriorityPanel.add(new JLabel("Szukaj po priorytecie:"));
    ...
    private JPanel createDeleteByDatePanel() {
        ...
        deleteByDatePanel.add(new JLabel("Skasuj zadania dla wybranego dnia:"));
    ...
    private JPanel createDeleteByDateIntervalPanel() {
        ...
        deleteByDateIntervalPanel.add(new JLabel("Skasuj zadania dla wybranego przedziału dat:"));
    ...
    private JPanel createResultsPanel() {
        ...
        resultsPanel.add(new JLabel("Ostatnie wyszukiwanie:"));
